  ...
  return (
    <Container maxWidth="md">
        ...
        {canDartslive && dlData && c && (
          <>
              ...
              >
                <Box>
                  <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                    <Typography
                      variant="h3"
                      sx={{ fontWeight: 'bold', color: flightColor, lineHeight: 1 }}
                    >
                      {c.rating?.toFixed(2) ?? '--'}
                    </Typography>
                  ...
                  return (
                    <Box sx={{ mt: 1.5 }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.3 }}>
                        ...
                        <Typography
                          variant="caption"
                          sx={{ fontWeight: 'bold', color: flightColor }}
                        >
                          {progress.toFixed(0)}%
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
              ...
              {periodLoading ? (
                ...
                <>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, mb: 1.5, flexWrap: 'wrap' }}>
                    <Paper
                      variant="outlined"
                      sx={{ flex: 1, minWidth: 80, p: 1, textAlign: 'center' }}
                    >
                      <Typography variant="caption" color="text.secondary">
                        Avg Rt
                      </Typography>
                      ...
                      {periodSummary.ratingChange != null && (
                        <Typography
                          variant="caption"
                          sx={{
                            color: periodSummary.ratingChange >= 0 ? '#4caf50' : '#f44336',
                            fontWeight: 'bold',
                          }}
                        >
                          {periodSummary.ratingChange >= 0 ? '+' : ''}
                          {periodSummary.ratingChange.toFixed(2)}
                        </Typography>
                      )}
                    </Paper>
                    <Paper
                          ...
                          {periodSummary.bestRating != null && (
                            <Box>
                              ...
                              <Typography variant="body2" sx={{ fontWeight: 'bold' }}>
                                {periodSummary.bestRating.toFixed(2)}
                              </Typography>
                            </Box>
                          )}
                          {periodSummary.bestPpd != null && (
                            <Box>
                              ...
                              <Typography variant="body2" sx={{ fontWeight: 'bold' }}>
                                {periodSummary.bestPpd.toFixed(2)}
                              </Typography>
                            </Box>
                          )}
                          {periodSummary.bestMpr != null && (
                            <Box>
                              ...
                              <Typography variant="body2" sx={{ fontWeight: 'bold' }}>
                                {periodSummary.bestMpr.toFixed(2)}
                              </Typography>
                            </Box>
                          )}
                        </Box>
            ...
            <Box sx={{ display: 'flex', gap: 1.5, mb: 2 }}>
              ...
              {/* Cricket */}
              <Paper
                sx={{ flex: 1, p: 1.5, borderRadius: 2, borderTop: `3px solid ${COLOR_CRICKET}` }}
              >
              ...
              {/* COUNT-UP */}
              <Paper
                sx={{ flex: 1, p: 1.5, borderRadius: 2, borderTop: `3px solid ${COLOR_COUNTUP}` }}
              >
                  ...
                  >
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 1.5 }}>
                      ...
                      <Typography variant="caption" color="text.secondary" sx={{ ml: 'auto' }}>
                        01 Rt: {target.current01Rt.toFixed(2)} / Cri Rt:{' '}
                        {target.currentCriRt.toFixed(2)}
                      </Typography>
                    </Box>
                    <Box sx={{ display: 'flex', gap: 1.5 }}>
                      <Paper
                        variant="outlined"
                        sx={{ flex: 1, p: 1.5, borderColor: COLOR_01 + '44' }}
                      >
                        <Typography variant="caption" sx={{ color: COLOR_01, fontWeight: 'bold' }}>
                          01だけで上げる場合
                        </Typography>
                        {target.ppd01Only.achieved ? (
                          <Typography
                            variant="body1"
                            sx={{ mt: 0.5, color: 'success.main', fontWeight: 'bold' }}
                          >
                            達成済み
                          </Typography>
                        ) : (
                      ...
                      <Paper
                        variant="outlined"
                        sx={{ flex: 1, p: 1.5, borderColor: COLOR_CRICKET + '44' }}
                      >
                        <Typography
                          variant="caption"
              ...
              <Paper sx={{ p: 2, mb: 2, borderRadius: 2 }}>
                ...
                >
                  ...
                  >
                    ...
                    <ToggleButton
                      value="cricket"
                      sx={{ '&.Mui-selected': { color: COLOR_CRICKET } }}
                    >
                      Cri
                    </ToggleButton>
                    <ToggleButton
                      value="countUp"
                      sx={{ '&.Mui-selected': { color: COLOR_COUNTUP } }}
                    >
                      CU
                    </ToggleButton>
                  </ToggleButtonGroup>
                ...
                {isCountUpCategory && expectedCountUp != null && (
                  <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap', mt: 1, mb: 0.5 }}>
                    {excellentCountUp != null && (
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                        <Box
                          sx={{ width: 10, height: 10, borderRadius: '50%', bgcolor: '#2e7d32' }}
                        />
                        <Typography variant="caption" color="text.secondary">
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                      <Box
                        sx={{ width: 10, height: 10, borderRadius: '50%', bgcolor: '#4caf50' }}
                      />
                      <Typography variant="caption" color="text.secondary">
                    ...
                    {dangerCountUp != null && (
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                        <Box
                          sx={{ width: 10, height: 10, borderRadius: '50%', bgcolor: '#f44336' }}
                        />
                        <Typography variant="caption" color="text.secondary">
                        ...
                        {selectedGame.scores.map((s, i) => {
                          ...
                          return (
                            <Chip
                              key={i}
                              label={
                                gameChartCategory.includes('CRICKET') &&
                                !gameChartCategory.includes('COUNT')
                                  ? s.toFixed(2)
                                  : s
                              }
                              size="small"
              ...
              <Paper sx={{ p: 2, mb: 2, borderRadius: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                  <Box>
                    ...
                    <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                      {dlData.recentGames.dayStats.avg01?.toFixed(2)} /{' '}
                      {dlData.recentGames.dayStats.best01?.toFixed(2)}
                    </Typography>
                  </Box>
                  <Box>
                    ...
                    <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                      {dlData.recentGames.dayStats.avgCri?.toFixed(2)} /{' '}
                      {dlData.recentGames.dayStats.bestCri?.toFixed(2)}
                    </Typography>
                  </Box>
                  {dlData.recentGames.dayStats.avgCountUp !== null && (
                    <Box>
                      ...
                      <Typography variant="body1" sx={{ fontWeight: 'bold' }}>
                        {dlData.recentGames.dayStats.avgCountUp?.toFixed(0)} /{' '}
                        {dlData.recentGames.dayStats.bestCountUp}
                      </Typography>
                    </Box>
                  )}
                </Box>
                      ...
                      {AWARD_ORDER.filter((key) => c.awards[key]).map((key) => (
                        <TableRow key={key}>
                          ...
                          <TableCell align="right">
                            {c.awards[key].monthly.toLocaleString()}
                          </TableCell>
                          <TableCell align="right" sx={{ fontWeight: 'bold' }}>
                            {c.awards[key].total.toLocaleString()}
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
      ...
      {canDartslive && (
        <Dialog
          open={dlOpen}
          onClose={() => !dlLoading && setDlOpen(false)}
          maxWidth="xs"
          fullWidth
        >
