      ...
      {!hasResults ? (
        ...
        <>
          ...
          <Grid container spacing={2}>
            ...
            {results && results.map(({ barrel, matchPercent }) => (
          ...
          {results && (
            <Paper sx={{ mt: 3, p: 2.5, textAlign: 'center', border: '1px dashed', borderColor: 'primary.main', borderRadius: 2, bgcolor: 'background.default' }}>
