  ...
  return (
    <Container maxWidth="sm">
      <Box component="form" onSubmit={handleSubmit} sx={{ mt: 4, p: { xs: 2, sm: 3 } }}>
        ...
        {isAdmin && session?.user?.id && (
          <>
            ...
            <LineLinkSection
              ...
              hasDlCredentials={hasDlCredentials}
              onLineUserIdChange={setLineUserId}
              onLineNotifyChange={setLineNotifyEnabled}
              onDlCredentialsChange={setHasDlCredentials}
        ...
        <Divider sx={{ my: 4 }} />
        <AccountDeleteSection onError={setError} />
      </Box>
    </Container>
  );
}
