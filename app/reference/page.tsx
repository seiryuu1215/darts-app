...
const shaftData: ShaftBrand[] = [
  {
    ...
    entries: [
      ...
      { product: 'Slim', size: '26.0mm', weight: 0.90 },
  ...
  },
  {
    ...
    entries: [
      ...
      { product: 'LARO', size: '330', weight: 1.20 },
      { product: 'LARO Carbon', size: '130', weight: 0.70 },
      ...
      { product: 'L-Style Carbon', size: '330', weight: 1.20 },
    ],
  },
  {
    brand: 'Fit Flight',
    entries: [
      ...
      { product: 'ロック', size: '300', weight: 0.70 },
      ...
      { product: 'ストレートグラデーション', size: '300', weight: 0.80 },
  ...
  },
  {
    ...
    entries: [
      ...
      { product: 'Dragster', size: '21mm', weight: 0.80 },
      ...
      { product: 'PC Shaft', size: '35mm', weight: 1.40 },
    ],
  },
  {
    brand: 'Master Shaft',
    entries: [
      ...
      { product: 'Master Shaft Plus', size: 'M', weight: 0.40 },
  ...
  },
  {
    ...
    entries: [
      ...
      { product: 'ラロ', size: '330', weight: 1.20 },
      { product: 'ラロ カーボン', size: '130', weight: 0.70 },
      ...
      { product: 'エルスタイルカーボン', size: '330', weight: 1.20 },
    ],
  },
  {
    brand: 'Clic',
    entries: [
      { product: 'Standard', size: 'S', weight: 0.80 },
      { product: 'Standard', size: 'I', weight: 1.00 },
      { product: 'Standard', size: 'M', weight: 1.15 },
      { product: 'Slim', size: 'S', weight: 0.55 },
      { product: 'Slim', size: 'I', weight: 0.60 },
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ display: 'flex', gap: 1, mb: 3, flexWrap: 'wrap' }}>
        <Chip icon={<Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: 'success.main', ml: 1 }} />} label="軽量（〜0.7g）" size="small" variant="outlined" />
        <Chip icon={<Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: 'warning.main', ml: 1 }} />} label="標準（0.7〜1.0g）" size="small" variant="outlined" />
        <Chip icon={<Box sx={{ width: 8, height: 8, borderRadius: '50%', bgcolor: 'error.main', ml: 1 }} />} label="重め（1.0g〜）" size="small" variant="outlined" />
      </Box>
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ fontWeight: 'bold' }} align="right">重量</TableCell>
                <TableCell sx={{ fontWeight: 'bold' }} align="center">区分</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {current.entries.map((entry, i) => {
                const isFirstOfProduct = i === 0 || current.entries[i - 1].product !== entry.product;
                const productRowCount = current.entries.filter((e) => e.product === entry.product).length;
                return (
                  <TableRow key={`${entry.product}-${entry.size}`} sx={{ '&:last-child td': { borderBottom: 0 } }}>
                    {isFirstOfProduct && (
                      <TableCell
                        rowSpan={productRowCount}
                        sx={{ fontWeight: 'bold', borderRight: 1, borderColor: 'divider', verticalAlign: 'top' }}
                      >
                        {entry.product}
                      </TableCell>
                    )}
