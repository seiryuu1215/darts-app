...
export const RANKS: RankDefinition[] = [
  ...
  { level: 21, name: 'OVERLORD', requiredXp: 80000, icon: '🔱', color: '#9C27B0' },
  { level: 22, name: 'TITAN', requiredXp: 100000, icon: '🔱', color: '#6A1B9A' },
  { level: 23, name: 'MYTHIC', requiredXp: 125000, icon: '🌀', color: '#4A148C' },
  { level: 24, name: 'ASCENDANT', requiredXp: 155000, icon: '🌀', color: '#311B92' },
  { level: 25, name: 'ETHEREAL', requiredXp: 190000, icon: '✨', color: '#1A237E' },
  { level: 26, name: 'CELESTIAL', requiredXp: 230000, icon: '✨', color: '#0D47A1' },
  { level: 27, name: 'TRANSCENDENT', requiredXp: 280000, icon: '💠', color: '#006064' },
  { level: 28, name: 'OMNISCIENT', requiredXp: 340000, icon: '💠', color: '#004D40' },
  { level: 29, name: 'ABSOLUTE', requiredXp: 420000, icon: '🌌', color: '#1B5E20' },
  { level: 30, name: 'BEYOND GOD', requiredXp: 500000, icon: '🌌', color: '#BF360C' },
];
