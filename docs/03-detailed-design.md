...
│                                          │
│  [直近プレイデータ]                        │
│  ComposedChart (BarChart + 移動平均Line)  │
│                                          │
│  [Awards テーブル]                        │
│  HAT TRICK: 今月 5 / 累計 120            │
└──────────────────────────────────────────┘
```
...
```json
{
  ...
  "data": {
    ...
    "monthly": {
      "rating": [{ "month": "2025/01", "value": 10.20 }],
      "zeroOne": [{ "month": "2025/01", "value": 22.80 }],
      "cricket": [{ "month": "2025/01", "value": 2.05 }],
      "countUp": [{ "month": "2025/01", "value": 510 }]
    },
    "recentGames": {
      "dayStats": {
        "best01": 30.5, "bestCri": 3.2, "bestCountUp": 650,
        "avg01": 24.1, "avgCri": 2.1, "avgCountUp": 520
      },
      "games": [
        { "category": "01 GAMES", "scores": [25.3, 22.1, 28.4] }
      ],
      "shops": ["ダーツショップA"]
    },
    "prev": {
...
└── Providers (SessionProvider + ThemeProvider)
    ...
    │   │       └── ImageUpload
    │   ├── StatsPage
    │   │   ├── RatingHeroCard (flight-colored)
    │   │   ├── StatsCategoryCards (01/Cri/CU)
    │   │   ├── ActiveDartDisplay
